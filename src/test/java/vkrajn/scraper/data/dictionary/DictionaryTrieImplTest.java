...
/**
 * A test class for {@link DictionaryTrieImpl}.
 *
 * @author Vojtech Krajnansky
 * @version 07/19/2017
 */
public class DictionaryTrieImplTest {
    ...
    DictionaryTrieImpl dict = new DictionaryTrieImpl();

    /**
     * Test of insert method, of class DictionaryTrieImpl.
     */
    @Test
    ...
    /**
     * Test of getWordFrequency method, of class DictionaryTrieImpl.
     */
    @Test
    ...
    public void testGetWordFrequencies() {
        ...
        assertTrue(dict.getWordFrequencies().get(0).getWord().equals(words[2]));
        assertTrue(dict.getWordFrequencies().get(1).getWord().equals(words[3]));
        assertTrue(dict.getWordFrequencies().get(0).getFrequency() == 2);
        assertTrue(dict.getWordFrequencies().get(1).getFrequency() == 1);
    ...
    /**
     * Test of getLongestWords method, of class DictionaryTrieImpl.
     */
    @Test
